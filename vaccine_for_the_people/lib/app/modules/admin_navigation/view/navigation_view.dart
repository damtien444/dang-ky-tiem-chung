                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Nếu bạn đăng xuất, quyền admin hiện tại sẽ không còn hiệu lực, bạn phải thực hiện đăng nhập lại để có thể thực hiện các thao tác của nhà quản lí !!!",
                                          textAlign: TextAlign.center,
                                          style: TextStyle(
                                              fontSize: 14,
                                              color: Colors.grey,
                                          ...
                                          children: [
                                              ...
                                              child: ElevatedButton(
                                                style: ElevatedButton.styleFrom(
                                                  primary: CustomeColor
                                                      .colorAppBar, //background color of button
                                            ...
                                            SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                style: ElevatedButton.styleFrom(
                                                  primary: Colors
                                                      .red, //background color of button
                                                  // side: const BorderSide(width:1, color:Colors.grey), //border width and color//elevation of button
                                                  shape: RoundedRectangleBorder(
                                                      //to set border radius to button
                                                      borderRadius:
